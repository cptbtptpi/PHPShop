...
<div class="m-b-md">
    <h2 class="m-b-none">分类管理/添加顶级分类</h2>
</div>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" name="c_name"  class="form-control" placeholder="请填写分类名称">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label for="" class="col-sm-2 control-label">所属层数</label>
                <div class="col-sm-9">
                    <input type="text" name="c_ceng"  class="form-control" placeholder="请填写分类所属的层数">
                </div>
            </div>
            <div class="form-group">
                <label for="" class="col-sm-2 control-label">分类排序</label>
                <div class="col-sm-9">
                    <input type="number" name="c_sort"  class="form-control" placeholder="请填写分类排序">
                </div>
            </div>
        </div>
    </div>
