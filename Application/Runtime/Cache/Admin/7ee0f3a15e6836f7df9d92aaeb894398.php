            ...
            <div class="panel-body">
                <table class="table table-hover">
                    ...
                    <?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
                            <td><?php echo ($v['ta_id']); ?></td>
                            <td><?php echo ($v['attr_name']); ?></td>
                            <td style="width: 50%;"><?php echo ($v['attr_value']); ?></td>
                            <td>
                                <?php if($v['attr_type'] == 2) {echo '属性';} else {echo '规格';} ?>
                            </td>
                            <td>
                                <div class="btn-group">
                                    <a href="<?php echo u('admin/typeAttr/edit',['ta_id'=>$v['ta_id']]);?>" class="btn btn-info">编辑</a>
                                    <a href="<?php echo u('admin/typeAttr/del',['ta_id'=>$v['ta_id']]);?>" class="btn btn-danger">删除</a>
                                </div>
                            </td>
...
<div class="btn-group">
    <a href="<?php echo u('admin/typeAttr/add',['jn_type_t_id'=>$list[0]['jn_type_t_id']]);?>" class="btn btn-primary">添加</a>
</div>
