                    ...
                    <?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
                            ...
                            <td>
                                <ul style="padding-left: 0;">
                                    <li>市场价<del><?php echo ($v['market_price']); ?></del></li>
                                    <li style="color: #ff0000;">商城价<span><?php echo ($v['mall_price']); ?></span></li>
                                </ul>
                            </td>
                            <td><?php echo ($v['total_inventory']); ?></td>
                            <td><?php echo ($v['click_rate']); ?></td>

                            <td><?php echo (date("Y-m-d H:i",$v['launch_time'])); ?></td>
                            <td>
                                <a href="<?php echo u('GoodsList/index',['g_id'=>$v['g_id']]);?>" class="btn btn-primary">货品列表</a>
                                <a href="<?php echo u('edit',['g_id'=>$v['g_id']]);?>" class="btn btn-info">编辑</a>
                                <a href="javascript:;" onclick="del(<?php echo ($v['g_id']); ?>)" class="btn btn-danger">删除</a>
                            </td>
        ...
        var obj = util.modal({
            ...
            events:{
                confirm:function(){
                    ...
                    location.href = "<?php echo u('del');?>" + '?g_id=' + g_id;
                }
            }
