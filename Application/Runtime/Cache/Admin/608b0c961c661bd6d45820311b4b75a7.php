...
<div class="m-b-md">
    <h2 class="m-b-none">商品管理/商品编辑</h2>
</div>
    ...
    <div class="panel-body">
        <form class="form-horizontal" method="post" action="">
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" name="goods_name" value="<?php echo ($oldData['goods_name']); ?>" class="form-control">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" name="goods_number" value="<?php echo ($oldData['goods_number']); ?>" class="form-control">
                </div>
            </div>
            <div class="line line-dashed line-lg pull-in"></div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <select name="jn_category_c_id" class="form-control m-b">
                        ...
                        <?php if(is_array($cateData)): foreach($cateData as $key=>$v): ?><option value="<?php echo ($v['c_id']); ?>" t_id="<?php echo ($v['jn_type_t_id']); ?>" <?php if($oldData['jn_category_c_id']==$v['c_id']): ?>selected<?php endif; ?>><?php echo ($v['_c_name']); ?></option><?php endforeach; endif; ?>
                    </select>
                </div>
            </div>
            <script>
                $(function () {
                    // 获取旧数据的c_id
                    var selected_c_id = $('select[name=jn_category_c_id]').find('option:selected').val();
                    // 获取旧数据
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <table class="table table-hover" id="attr">
                        <?php if(is_array($typeAttr)): foreach($typeAttr as $key=>$v): ?><tr>
                                <td><?php echo ($v['attr_name']); ?></td>
                                <td>
                                    <select name="attr[<?php echo ($v['ta_id']); ?>]">
                                        <option value="0">请选择</option>
                                        <?php if(is_array($v["attr_value"])): foreach($v["attr_value"] as $key=>$vv): ?><option value="<?php echo ($vv); ?>" <?php if(in_array($vv,$checkAttr)): ?>selected<?php endif; ?>><?php echo ($vv); ?></option><?php endforeach; endif; ?>
                                    </select>
                                </td>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <table class="table table-hover" id="spec">
                        <?php if(is_array($typeSpec)): foreach($typeSpec as $key=>$v): ?><tr>
                                <td><?php echo ($v['attr_name']); ?></td>
                                <td>
                                    <select name="spec[<?php echo ($v['ta_id']); ?>][color][]">
                                        <option value="0">请选择</option>
                                        <?php if(is_array($v['attr_value'])): foreach($v['attr_value'] as $key=>$vv): ?><option value="<?php echo ($vv); ?>" <?php if($v['goods_attr_name']==$vv): ?>selected<?php endif; ?>><?php echo ($vv); ?></option><?php endforeach; endif; ?>
                                    </select>
                                </td>
                                <td>
                                    附加价格
                                ...
                                <td>
                                    <input type="text" name="spec[<?php echo ($v['ta_id']); ?>][added][]" value="<?php echo ($v['added']); ?>">
                                </td>
                                <td>
                            ...
                            <script>
                                $(function(){
                                    $('#spec').find("tr:contains(<?php echo ($v['attr_name']); ?>)").eq(0).find("td:last").html('<button type="button" class="btn btn-success btn-xs addSpec">添加</button>');
                                })
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <select name="jn_brand_b_id" class="form-control m-b">
                        <option value="0">请选择</option>
                        <?php if(is_array($brandData)): foreach($brandData as $key=>$v): ?><option value="<?php echo ($v['b_id']); ?>" <?php if($oldData['jn_brand_b_id']==$v['b_id']): ?>selected<?php endif; ?>><?php echo ($v['b_name']); ?></option><?php endforeach; endif; ?>
                    </select>
                </div>
            </div>
            <div class="line line-dashed line-lg pull-in"></div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" name="goods_unit" class="form-control" id="input-id-1" value="<?php echo ($oldData['goods_unit']); ?>">
                </div>
            </div>
            <div class="line line-dashed line-lg pull-in"></div>
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="number" name="market_price" value="<?php echo ($oldData['market_price']); ?>" class="form-control">
                </div>
            </div>
            <div class="line line-dashed line-lg pull-in"></div>
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="number"  class="form-control" name="mall_price" value="<?php echo ($oldData['mall_price']); ?>" placeholder="">
                </div>
            </div>
            <div class="line line-dashed line-lg pull-in"></div>
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text"  class="form-control" name="click_rate" value="<?php echo ($oldData['click_rate']); ?>" placeholder="">
                </div>
            </div>
            <div class="line line-dashed line-lg pull-in"></div>
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text"  class="form-control" name="total_inventory" value="<?php echo ($oldData['total_inventory']); ?>" placeholder="">
                </div>
            </div>
            <div class="line line-dashed line-lg pull-in"></div>
            ...
            <div class="form-group">
                ...
                <?php
 $big = explode('|',$oldData['big_pic']); ?>
                <div class="col-sm-8 col-sm-offset-2" id="box">
                    <?php if(is_array($big)): foreach($big as $key=>$v): ?><li>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <textarea id="container1" name="goods_detail" style="height:300px;width:100%;"><?php echo ($oldData['goods_detail']); ?></textarea>
                    <script>
                        require(['util'], function (util) {
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <textarea id="container" name="service" style="height:300px;width:100%;"><?php echo ($oldData['service']); ?></textarea>
                    <script>
                        require(['util'], function (util) {
