        ...
        <section class="panel panel-default">
            <div class="panel-body">
                <table class="table table-hover">
                   ...
                   <tr>
                       <th>编号</th>
                       <?php if(is_array($attr_name)): foreach($attr_name as $key=>$v): ?><th><?php echo ($v); ?></th><?php endforeach; endif; ?>
                       <th>货号</th>
                       <th>库存</th>
                       <th>操作</th>
                   </tr>
                    ...
                    <tbody>
                    <?php if(is_array($oldData)): foreach($oldData as $key=>$v): ?><tr>
                            <td><?php echo ($v['gl_id']); ?></td>
                            <?php if(is_array($v['goods_attr_name'])): foreach($v['goods_attr_name'] as $key=>$vv): ?><td><?php echo ($vv); ?></td><?php endforeach; endif; ?>
                            <td><?php echo ($v['goods_number']); ?></td>
                            <td><?php echo ($v['inventory']); ?></td>
                            <td>
                                <a href="<?php echo u('edit',['gl_id'=>$v['gl_id'],'g_id'=>I('get.g_id')]);?>" class="btn btn-info">编辑</a>
                                <a href="javascript:;" onclick="del(<?php echo ($v['gl_id']); ?>,<?php echo ($v['g_id']); ?>)" class="btn btn-danger">删除</a>
                            </td>
...
<div class="btn-group">
    <a href="<?php echo u('admin/GoodsList/add',['g_id'=>I('get.g_id')]);?>" class="btn btn-success">货品添加</a>
</div>
<script>
        ...
        var obj = util.modal({
            ...
            events:{
                confirm:function(){
                    ...
                    location.href = "<?php echo u('GoodsList/del');?>" + '?gl_id=' + gl_id + '&g_id=' + g_id;
                }
            }
