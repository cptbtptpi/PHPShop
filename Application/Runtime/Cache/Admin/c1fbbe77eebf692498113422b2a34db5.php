...
<div class="m-b-md">
    <h2 class="m-b-none">货品管理/货品添加</h2>
</div>
<form class="form-horizontal" id="form" action="" method="post">
    <div class="panel panel-default">
        <div class="panel-body">
            <?php if(is_array($oldData)): foreach($oldData as $key=>$v): ?><div class="form-group">
                <label for="" class="col-sm-2 control-label"><?php echo ($v['attr_name']); ?></label>
                <div class="col-sm-3">
                    <select class="form-control" name="combine[]">
                        <?php if(is_array($v['select'])): foreach($v['select'] as $key=>$vv): ?><option value="<?php echo ($vv['ga_id']); ?>"><?php echo ($vv['goods_attr_name']); ?></option><?php endforeach; endif; ?>
                    </select>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="number" name="inventory" value="" required value="0" min="0">
                </div>
            </div>
            <div class="form-group">
                <label for="" class="col-sm-2 control-label">货号</label>
                <div class="col-sm-9">
                    <input type="text" name="goods_number" value="" placeholder="请输入货号" required>
                </div>
            </div>
        </div>
    </div>
