...
<div class="m-b-md">
    <h2 class="m-b-none">品牌管理/品牌列表</h2>
</div>
<div class="row">
    <div class="col-sm-12">
            ...
            <div class="panel-body">
                <table class="table table-hover">
                    ...
                    <?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
                            ...
                            <td><?php echo ($v['b_ceng']); ?></td>
                            <td style="max-width: 100px;"><img src="<?php echo ($v['b_logo']); ?>" alt="" style="height: 30px;"></td>
                            <td>
                                <?php if($v['b_hot'] == 1 ): ?>热门
                            ...
                            <td>
                                <div class="btn-group">
                                    <a href="<?php echo u('admin/brand/save',['b_id'=>$v['b_id']]);?>" class="btn btn-info">编辑</a>
                                    <a href="javascript:;" onclick="del(<?php echo ($v['b_id']); ?>)" class="btn btn-danger">删除</a>
                                </div>
                            </td>
        ...
        var obj = util.modal({
            ...
            events:{
                confirm:function(){
                    ...
                    location.href = "<?php echo u('admin/brand/del');?>" + '?b_id=' + b_id;
                }
            }
