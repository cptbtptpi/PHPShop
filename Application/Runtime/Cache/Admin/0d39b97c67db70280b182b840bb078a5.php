            ...
            <div class="panel-body">
                <table class="table table-hover">
                    ...
                    <?php if(is_array($data)): foreach($data as $key=>$v): ?><tr>
                            ...
                            <td><?php echo ($v['account_balance']); ?></td>
                            <td><?php echo date('Y-m-d H:i:s',$v['login_time']); ?></td>
                            <td>
                                <div class="btn-group">
                                    <a href="<?php echo u('admin/ForeUser/edit',['u_id'=>$v['u_id']]);?>" class="btn btn-info">编辑</a>
                                    <?php if (time() - $v['login_time'] > 60*60*24*30*6) { ?>
                                    <a href="javascript:;" onclick="del(<?php echo ($v['u_id']); ?>)" class="btn btn-danger">删除</a>
                                    <?php } ?>
                                </div>
                            </td>
        ...
        var obj = util.modal({
            ...
            events:{
                confirm:function(){
                    ...
                    location.href = "<?php echo u('admin/ForeUser/del');?>" + '?u_id=' + u_id;
                }
            }
