...
<div class="m-b-md">
    <h2 class="m-b-none">分类管理/分类列表</h2>
</div>
<div class="row">
    <div class="col-sm-12">
        <section class="panel panel-default">
            <div class="panel-body">
                <table class="table table-hover">
                    ...
                    <tbody>
                    <?php if(is_array($treeData)): foreach($treeData as $key=>$v): ?><tr>
                            <td><?php echo ($v['c_id']); ?></td>
                            <td><?php echo ($v['_c_name']); ?></td>
                            <td>
                                <div class="btn-group">
                                    <a href="<?php echo u('admin/cate/addSon',['c_id'=>$v['c_id']]);?>" class="btn btn-primary">添加子分类</a>
                                    <a href="<?php echo u('admin/cate/edit',['c_id'=>$v['c_id']]);?>" class="btn btn-info">编辑</a>
                                    <a href="javascript:;" onclick="del(<?php echo ($v['c_id']); ?>)" class="btn btn-danger">删除</a>
                                </div>
                            </td>
        ...
        var obj = util.modal({
            ...
            events:{
                confirm:function(){
                    ...
                    location.href = "<?php echo u('admin/cate/del');?>" + '?c_id=' + c_id;
                }
            }
