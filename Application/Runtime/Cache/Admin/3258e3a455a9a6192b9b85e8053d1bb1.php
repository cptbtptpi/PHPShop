...
<div class="m-b-md">
    <h2 class="m-b-none">订单管理/订单详情</h2>
</div>
<div class="row">
    <div class="col-sm-12">
        <section class="panel panel-default">
            <div class="panel-body">
                <table class="table table-hover">
                    ...
                    <tbody>
                    <?php if(is_array($orderListData)): foreach($orderListData as $key=>$v): ?><tr>
                            <td><?php echo ($v['ol_id']); ?></td>
                            <td><?php echo ($v['name']); ?></td>
                            <td><img width="50" height="50" src="<?php echo ($v['pic']); ?>" alt=""></td>
                            ...
                            <!--<td>-->
                                <!--<div class="btn-group">-->
                                    <!--<a href="<?php echo u('admin/OrderMange/show',['i_id'=>$v['i_id']]);?>" class="btn btn-info">查看</a>-->
                                    <!--<?php if($v['order_payment'] == 0): ?><a href="javascript:;" onclick="del(<?php echo ($v['i_id']); ?>)" class="btn btn-danger">删除</a><?php else: ?><a href="" class="btn btn-primary">发货</a><?php endif; ?>-->
                                <!--</div>-->
                            <!--</td>-->
