...
<head>
    ...
    <link rel="stylesheet" href="/wancezy/JDshop/Public/Home/css/searchList.css">
    <script src="/wancezy/JDshop/Public/Home/js/jquery-1.11.1.min.js"></script>
    <script>
        $(function () {
            $(".selector .s-category .sl-v-list li").click(function () {
    ...
    <style>
        .sl-value .sl-v-list li a.hover {
            color: #E4393C;
            border: 1px solid #e4393c;
        }
    </style>
</head>
<body class="search-list">
<!--shortcut开始-->
<div id="shortcut-2">
    <div class="w">
        <ul class="fl">
    ...
    <div class="w">
        <div class="crumbs-bar">
            <div class="crumbs-nav">
                <div class="crumbs-nav-main clearfix">
                    ...
                    <?php if(is_array($fatherData)): foreach($fatherData as $key=>$v): ?><i class="crumbs-arrow">&gt;</i>
                    <a class="crumb-select-item" href="<?php echo u('List/index',['c_id'=>$v['id']]);?>"><?php echo ($v['name']); ?></a><?php endforeach; endif; ?>
        ...
        <div id="container">
            <div class="selector">
                ...
                <?php if(is_array($newArr)): foreach($newArr as $k=>$v): ?><div class="s-line">
                    <div class="sl-wrap">
                        <div class="sl-key">
 ...
 $temp = $param; $temp[$k] = 0; ?>
                        <div class="sl-value">
                            <div class="sl-v-list">
                                <ul>
                                    <li>
                                        <a href="<?php echo u('index',['c_id'=>$_GET['c_id'],'param'=>implode('_',$temp)]);?>" <?php if($param[$k]==0): ?>class="hover"<?php endif; ?>>不限</a>
                                    </li>
                                    <?php if(is_array($v['value'])): foreach($v['value'] as $kk=>$vv): ?><li>
                                        <?php $temp[$k]=$vv['ga_id']?>
                                        <a href="<?php echo u('index',['c_id'=>$_GET['c_id'],'param'=>implode('_',$temp)]);?>" <?php if($param[$k]==$vv['ga_id']): ?>class="hover"<?php endif; ?>><?php echo ($vv['goods_attr_name']); ?></a>
                                    </li><?php endforeach; endif; ?>
                                </ul>
                            </div>
                            <div class="sl-v-btns"></div>
                        </div>
                        <div class="sl-ext">
                            <a href="javascript:;" class="sl-e-more" style="visibility: visible;">
                                更多
                                <i></i>
                            </a>
                            <a class="sl-e-multiple" href="javascript:;" style="visibility: visible;">
                                多选
                                <i></i>
                            </a>
                        </div>
            ...
            <div class="g-main2">
                    ...
                    <div class="ml-wrap">
                        <div class="filter">
                            <div class="f-line top">
                                <div class="f-sort">
                                    <a href="javascript:;" class="curr composition">
                                        <span class="fs-tit">综合</span>
                                        <em class="fs-down">
                                            <i class="arrow"></i>
                                        </em>
                                    </a>
                                    <a href="javascript:;" class="sales-volume">
                                        <span class="fs-tit">销量</span>
                                        <em class="fs-down">
                                            <i class="arrow"></i>
                                        </em>
                                    </a>
                                    <a href="javascript:;" class="comments-num">
                                ...
                                <div class="f-price">
                                    <div class="f-price-set">
                                        <div class="fl">
                                            <input type="text" class="input-txt" style="color:#ccc" value="¥">
                                        </div>
                                        <em>-</em>
                                        <div class="fl">
                                            <input type="text" class="input-txt" style="color:#ccc" value="¥">
                                    ...
                                    <div class="f-price-edit">
                                        <a href="javascript:;" class="item1">清空</a>
                                        <a href="javascript:;" class="item2">确定</a>
                                    </div>
                                </div>
                                <div class="f-pager">
                                    <span class="fp-text">
                            ...
                            <div class="f-line">
                                <div class="f-store">
                                    ...
                                    <div class="ui-area-wrap ui-area-oversea-mode" style="float: left;margin-right: 10px;">
                                        <div class="ui-area-text-wrap">
                                            <div class="ui-area-text">北京朝阳区三环以内</div>
                                            <b></b>
                                        </div>
                                        <div class="ui-area-content-wrap ui-area-w-max"></div>
                                    </div>
                                </div>
                                <div class="f-feature">
                                    <ul>
                                        ...
                                        <li>
                                            <a class="" href="javascript:;">
                                                ...
                                                <span class="act-wrap" style="width:50px">
                                                    <em class="act-text">618</em>
                                                    <img src="/wancezy/JDshop/Public/Home/images/searchList/618.png">
                                                </span>
                                            </a>
                                        </li>
                                    </ul>
                                ...
                                <div class="f-search">
                                    <input type="text" value="" class="input-txt" placeholder="在结果中搜索">
                                    <a class="btn btn-default" href="javascript:;">确定</a>
                                </div>
                                <span class="clr"></span>
                            </div>
                        </div>
                        <div class="goods-list-v2 gl-type-2">
                            <ul class="gl-wrap clearfix">
                                <?php if(is_array($goodsData)): foreach($goodsData as $key=>$v): ?><li class="gl-item">
                                    <div class="gl-i-wrap">
                                        <div class="p-img">
                                            <a href="<?php echo u('content/index',['g_id'=>$v['g_id']]);?>">
                                                <img width="220" height="282" src="<?php echo ($v['pic']); ?>" alt="" class="err-product">
                                            </a>
                                        </div>
                                        <div class="p-price">
                                            <strong>
                                        ...
                                        <div class="p-commit">
                                            <strong>已有<a href=""><?php echo ($v['click_rate']); ?></a>条评价</strong>
                                        </div>
                                        <div class="p-focus">
                                            <a class="" href="javascript:;">
                                                <i></i>关注
                                        ...
                                        <div class="p-shop">
                                            <span>
                                                <a href=""><?php echo ($v['brand_name']); ?>官方旗舰店</a>
                                                <b class="im-01"></b>
                                            </span>
                                        </div>
                                        <div class="p-icons">
                                            <i class="goods-icons">满179-20</i>
                                        </div>
                                    </div>
                                </li><?php endforeach; endif; ?>
                            </ul>
                ...
                <div class="m-aside">
                    <div class="aside-bar">
                            ...
                            <div class="mc">
                                <ul class="clearfix">
                                    <li>
                                        <div class="p-img">
                                            <a href="">
                                                <img width="160" height="160" src="/wancezy/JDshop/Public/Home/images/searchList/aside-goods/aside-goods-1.jpg" alt="">
                                            </a>
                                        </div>
                                        <div class="p-price">
                                            <strong>
                                        ...
                                        <div class="p-name">
                                            <a href="">
                                                <em>麦潮尚 短袖T恤男士2017夏季<font class="skcolor_ljg">新款</font>时尚休闲3d印花t恤夜光衣 科比 L 120-140斤</em>
                                            </a>
                                        </div>
                                        <div class="p-comm" style="padding:8px 10px 0">
                                            已有<span style="color:#005aa0">6</span>人评价
                                        </div>
                                    </li>
                                    <li>
                                        <div class="p-img">
                        ...
                        <div class="promo-pic-adbox u-ad-wrap">
                            ...
                            <div class="bd">
                                <div class="mc">
                                    <div class="ab-pic">
                                        <a href="">
                                            <img src="/wancezy/JDshop/Public/Home/images/searchList/aside-goods/ab-pic-1.jpg" alt="">
                                        </a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="ab-pic">
                            <a href="">
                                <img width="180" height="240" src="/wancezy/JDshop/Public/Home/images/searchList/aside-goods/ab-pic-2.jpg" alt="">
                            </a>
                        </div>
                    </div>
                </div>
